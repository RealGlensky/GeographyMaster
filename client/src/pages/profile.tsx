...
import { Settings, User, Globe, Filter, Edit, Eye, EyeOff, Save, X, Brain, RefreshCw, Target } from "lucide-react";
...
export default function Profile() {
  ...
  const [hasFocusChanges, setHasFocusChanges] = useState(false);
